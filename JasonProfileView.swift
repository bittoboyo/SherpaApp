        ...
        ZStack{
            ScrollView{
                VStack {
                    ...
                    Text("Creative Storyteller at Fixar")
                        .font(.title2)
                        .foregroundColor(.black)
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("Nature lover and weekend hiker. Any favorite trails or outdoor spots you've recently discovered?")
