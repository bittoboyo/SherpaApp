        ...
        ZStack{
            ScrollView{
                VStack {
                    ...
                    Text("Business Dev Manager at Apple")
                        .font(.title2)
                        .foregroundColor(.black)
                    ...
                    VStack(alignment: .leading){
                        ...
                        Text("Fitness fanatic embracing new workouts. Any exercise routines or fitness goals you're passionate about?")
