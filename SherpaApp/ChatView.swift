...
//  SherpaApp
//
//  Created by Alver Remolar on 20/11/2023.
//
    ...
    var body: some View {
        ScrollView {
            VStack {
                HStack {
                    Text("John Smith")
                        .font(.custom(FontNames.arial, size: 24))
                ...
                Text("Online")
                    .font(.custom(FontNames.arial, size: 16))
                ...
                ChatBubble(direction: .left) {
                    Text("Hello John! I am here at Alpaca Coffee Shop until 4:30 pm.")
                        .padding(.all, 20)
                        .foregroundColor(Color.white)
